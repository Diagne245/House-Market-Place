...
import { getImagesIdsArray } from '../js/utilityMethods';
...
function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      imagesIds = await getImagesIdsArray(
    ...
    return (
      ...
      >
        <Card className="createListing">
          <Card.Body>
            <Card.Header>
              <h1 className="fs-1 mb-1 text-center">Create a Listing</h1>
            </Card.Header>
            ...
            >
              ...
              <p className="fs-7 opacity-75 mb-2">
